...
class AppConfig:
    ...
    def load(cls) -> "AppConfig":
        ...
        try:
            ...
            if isinstance(data, dict):
                ...
                cfg.num_chrome = int(data.get("NUM_CHROME", cfg.num_chrome) or cfg.num_chrome)
                ...
                cfg.wait_between_prompts = int(data.get("WAIT_BETWEEN_PROMPTS", cfg.wait_between_prompts) or cfg.wait_between_prompts)
    ...
    def save(self) -> None:
        ...
        data = {
            ...
            "NUM_CHROME": int(self.num_chrome or 1),
            ...
            "WAIT_BETWEEN_PROMPTS": int(self.wait_between_prompts or 12),
...
def apply_style(app: QApplication) -> None:
    ...
    QPushButton#Accent { background: #4a7cf3; border- color: white; }
    QPushButton#Accent:hover { background: #3a6be0; }
    QPushButton#Success { background: #16a34a; border- color: white; }
    QPushButton#Success:hover { background: #15803d; }
    QPushButton#Warning { background: #facc15; border- }
    QPushButton#Warning:hover { }
    QPushButton#Orange { background: #f97316; border- color: white; }
    QPushButton#Orange:hover { }
    QPushButton#Danger { background: #dc2626; border- color: white; }
