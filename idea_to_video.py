...
- Do NOT include logos, brand names, mascots, or "official/advertisement" language.
- Do NOT reference voice cloning or real voice likeness.
- EXTREMELY STRICT: Do NOT include ANY content involving violence, gore, hate speech, dangerous activities, sexual content, or nudity. Make sure all descriptions are completely harmless and friendly.
