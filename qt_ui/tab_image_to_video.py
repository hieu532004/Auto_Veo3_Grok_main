...
class _SingleImageTab(QWidget):
    ...
    def _build_image_cell(self, idx: int, path: str) -> tuple[QWidget, int]:
        ...
        if path:
            btn_name.setStyleSheet('QPushButton{border:none; background:transparent; padding:0px; text-align:center; font-size:10px; font-weight:600;}')
        else:
            btn_name.setStyleSheet('QPushButton{border:none; background:transparent; padding:0px; text-align:center; font-size:12px; font-weight:800;}')
        ...
        btn_del.setStyleSheet('background:#fee2e2; border:1px solid #fecaca; border-radius:11px; font-weight:400; font-size:14px; padding:0px;')
        ...
        btn_up.setStyleSheet(' border:1px solid #c8d7f2; border-radius:11px; font-weight:500; font-size:12px; padding:0px;')
        btn_down.setStyleSheet(' border:1px solid #c8d7f2; border-radius:11px; font-weight:500; font-size:12px; padding:0px;')
...
class _StartEndImageTab(QWidget):
    def __init__(self, parent: QWidget | None = None):
        ...
        step3.setStyleSheet('font-weight: 600;')
    ...
    def _build_image_cell(self, idx: int, path: str, role: str='start') -> tuple[QWidget, int]:
        ...
        if path:
            name_btn.setStyleSheet('QPushButton{border:none; background:transparent; padding:0px; text-align:center; font-size:10px; font-weight:600;}')
        else:
            name_btn.setStyleSheet('QPushButton{border:none; background:transparent; padding:0px; text-align:center; font-size:12px; font-weight:800;}')
