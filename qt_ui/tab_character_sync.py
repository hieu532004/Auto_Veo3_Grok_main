...
class _DropArea(QFrame):
    def __init__(self, tab: 'CharacterSyncTab'):
        ...
        self._empty.setStyleSheet(' font-weight:600;')
...
class _CharacterCard(QWidget):
    def __init__(self, tab: 'CharacterSyncTab', idx: int, path: str, name: str):
        ...
        self._img.setStyleSheet(' border:1px solid #c8d7f2; border-radius:8px;')
...
class CharacterSyncTab(QWidget):
    ...
    def __init__(self, parent: QWidget | None = None):
        ...
        self.drop.setStyleSheet('QFrame#DropArea{border:1px dashed #c8d7f2; border-radius:10px;}')
