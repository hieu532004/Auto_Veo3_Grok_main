...
class GrokSettingsTab(QWidget):
    def __init__(self, config, parent: QWidget | None = None):
        ...
        lb_account_type.setStyleSheet("font-weight:700;")
        lb_length = QLabel("Thời gian video:")
        lb_length.setStyleSheet("font-weight:700;")
        lb_resolution = QLabel("Chất lượng video:")
        lb_resolution.setStyleSheet("font-weight:700;")
        lb_multi = QLabel("MULTI VIDEO:")
        lb_multi.setStyleSheet("font-weight:700;")
        try:
        ...
        self.btn_open_login.setIcon(self.style().standardIcon(QStyle.StandardPixmap.SP_DirIcon))
        ...
        note.setStyleSheet(
            ...
            " border:1px solid #c8d7f2; border-radius:8px; padding:10px;"
        )
        body.addWidget(note)
        body.addStretch(1)
    ...
    def _show_profile_popup(self, profile_dir: str, host: str, port: int) -> None:
        if self._profile_popup is None:
            ...
            status.setStyleSheet(
                " font-size:12px; border:1px solid #c8d7f2; border-radius:8px; padding:8px;"
            )
